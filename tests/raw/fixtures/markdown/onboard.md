...
raw install <url>                 # Install remote tool from Git
...
class Workflow(BaseWorkflow[WorkflowParams]):
    @step("fetch")
    def fetch(self) -> dict:
        console.print("[blue]>[/] Fetching...")
        return fetch_data(limit=self.params.limit)
